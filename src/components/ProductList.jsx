...
const ProductList = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 p-6 bg-gray-900 text-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-semibold text-gray-200 mb-4">Product List</h2>
      <ul className="space-y-4">
        {products.map((product, index) => (
          <li
            key={index}
            className="flex justify-between items-center p-4 border border-gray-700 bg-gray-800 rounded-md"
          >
            <div>
      ...
      {editingProductID && (
        <div className="mt-6 p-4 bg-gray-800 rounded-md">
          ...
          <input
            type="text"
            className="w-full mb-4 px-3 py-2 border border-gray-600 bg-gray-700 text-white rounded-md"
